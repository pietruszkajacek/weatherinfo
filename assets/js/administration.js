WINFO = $.extend(true, (typeof WINFO === 'undefined') ? {} : WINFO, {
	administration: {
		...
		_submit: function (event) {
			...
			if (!WINFO.administration.front_end_cities_submit) {

				WINFO.administration.front_end_cities_submit = true;
				...
				$.ajax({
					...
					success: function (data) {
						...
						WINFO.administration.front_end_cities_submit = false;
